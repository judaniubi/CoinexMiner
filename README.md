...
# 更新
1. 由于Coinex已经停止了交易挖矿 本项目使用场景已经发生改变
2. Coinex时不时还是会对新币种做交易比赛 所以还是可以用本程序来刷量
3. 由于废除了难度查询api 所以这里用一个固定量 在配置文件里difficulty 
4. difficulty 决定你每小时挖的量 等值多少个cet 这里注意是手续费 不要设置太大了
